...
class Api::V1::DeltaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "returns changes since cursor" do
    ...
    menu_item = MenuItem.create!(shop: shops(:alpha), name: "Chai", category: "beverage", price_paise: 2000, hsn_sac: "996331")
  ...
  test "respects limit and reports has_more" do
    3.times { |i| MenuItem.create!(shop: shops(:alpha), name: "Item #{i}", category: "side", price_paise: 1000, hsn_sac: "996331") }
